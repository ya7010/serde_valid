...
//! built-in numbers implement the numeric validators directly. `Size`, `IsMatch`, and `IsUnique`
//! are deprecated. See [`traits`] for the full capability-to-validator map.
//!
