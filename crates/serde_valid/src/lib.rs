...
//!
//! Implement [`traits::Sequence`] once to apply field validation rules to the values of a custom
//! indexed collection. String length, array item count, and object property count remain separate
//! capabilities.
//!
...
/// Implementation details used by code generated by `serde_valid_derive`.
///
/// This module is public only because derive output is compiled in downstream crates. Its contents
/// are not part of the supported public API.
#[doc(hidden)]
pub mod __private {
    pub use crate::composited::{
        path, Composited, ValidateCompositedEnum, ValidateCompositedExclusiveMaximum,
